...
class Game:
    ...
    def draw_splash_screen(self):
        ...
        controls_text = self.font.render("Controls: Left/Right Arrows to move", True, settings.GRAY)
        ...
        controls_rect = controls_text.get_rect(center=(settings.SCREEN_WIDTH // 2, settings.SCREEN_HEIGHT * 4 // 5))
